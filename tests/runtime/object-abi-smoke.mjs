...
import { stdFormat as fmt } from "../../fixtures/js/std-format-values.mjs";
...
assert.equal(boxUInt32Entry.args[0].type.fields[0].type.interfaceTag, INTERFACE_TAG.UINT32);
...
assert.equal(boxUInt64Entry.args[0].type.fields[0].type.interfaceTag, INTERFACE_TAG.UINT64);
...
assert.equal(uint32BoxEntry.args[0].type.fields[0].type.interfaceTag, INTERFACE_TAG.UINT32);
...
assert.equal(uint64BoxEntry.args[0].type.fields[0].type.interfaceTag, INTERFACE_TAG.UINT64);
