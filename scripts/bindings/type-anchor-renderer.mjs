...
export async function runTypeAnchorRendererCli(argv) {
  ...
  if (cli.out === null) {
    ...
    const action = await emitGeneratedFile(cli.out, rendered, {
      check: cli.check,
      root,
      staleHint: "rerun the corresponding render step without --check",
    });
...
export function renderMarkdownReport(report) {
  ...
  const lines = [
    "<!-- Generated by scripts/bindings/render-type-anchors.mjs; edit the authored type-anchor inputs and regenerate this file. -->",
    "",
