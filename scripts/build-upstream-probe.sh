...

{
  ...
  echo "static Peano-shaped Nat representation. The Tamagotchi automaton is encoded"
  echo "as nullary inductive constructors and nested \`case\` bodies. Both demos run"
