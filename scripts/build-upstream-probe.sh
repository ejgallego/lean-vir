...
exports=(
  ...
  -Wl,--export=vir_call_resolved_primitive
  -Wl,--export=vir_call_primitive_set_u32
  -Wl,--export=vir_call_primitive_set_f64
  -Wl,--export=vir_call_primitive_set_string
  -Wl,--export=vir_call_primitive_u32_result
  -Wl,--export=vir_call_primitive_f64_result
  -Wl,--export=vir_call_primitive_string_result
