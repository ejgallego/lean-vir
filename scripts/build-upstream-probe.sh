...

{
  ...
  echo "stubs. \`runtime_environment_stubs.cpp\`, \`package_init_bridge.cpp\`,"
  echo "\`runtime_value_stubs.cpp\`, and \`io_stubs.cpp\` contain the remaining"
  echo "host/platform stubs. \`package_ir_decoder.cpp\`"
