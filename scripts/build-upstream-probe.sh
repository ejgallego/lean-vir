...

{
  ...
  echo "\`package/signature_cache.cpp\` owns cached package-call signature summaries."
  echo "\`package/call_signature_summary.cpp\` streams compact package signatures to compute"
  echo "arity and boxed-boundary requirements. \`runtime/name_utils.cpp\` contains shared"
  ...
  echo "host/platform stubs. \`package/package_ir_decoder.cpp\`"
  ...
  echo "objects. \`package/package_decl_provider.cpp\` owns the loaded package state and"
