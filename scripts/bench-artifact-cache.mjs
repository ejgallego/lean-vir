...
const sourceIdentityPaths = [
  ...
  "wasm/upstream_shim/runtime_environment_stubs.cpp",
  "wasm/upstream_shim/package_init_bridge.cpp",
  "wasm/upstream_shim/runtime_value_stubs.cpp",
  "wasm/upstream_shim/io_stubs.cpp",
