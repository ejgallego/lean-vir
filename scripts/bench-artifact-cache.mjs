...
const sourceIdentityPaths = [
  ...
  "wasm/upstream_shim/package/call_signature_summary.cpp",
  "wasm/upstream_shim/package/call_signature_summary.h",
  ...
  "wasm/upstream_shim/package/signature_cache.cpp",
  "wasm/upstream_shim/package/signature_cache.h",
