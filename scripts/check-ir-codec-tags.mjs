...
const leanTagsPath = new URL("../Vir/GeneratePackage/PackageIRTags.lean", import.meta.url);
...
const generatedFiles = [
  {
    path: new URL("../build/generated/wasm/package/package_ir_tags.h", import.meta.url),
...
function headerLines() {
  return [
    ...
    "C++ enum structure comes from `scripts/ir-codec-tags.mjs`.",
    "*/",
    "",
  ];
}
...
async function loadTagValues() {
  ...
  return IR_CODEC_TAG_GROUPS.map((group) => ({
    ...
    tags: group.tags.map((cppTag) => {
      ...
      if (matches.length !== 1) {
        throw new Error(`${fileURLToPath(leanTagsPath)} must define ${name} exactly once`);
      }
