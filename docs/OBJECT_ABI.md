...
| `vir_resolve_call` | Resolve a canonical escaped package entry name to a stable call slot. | Compatibility path; does not parse dotted text or transfer object ownership. |
