...
infoview.rpc.refs	infoview	rpc	partial	Vir.Infoview.ProofWidgetsRpc;Vir.ProofWidgets.Rpc	vir-host-bindings;vir-infoview-widget	test:infoview;test:runtime;test:upstream	RpcRef descriptors cross proofwidgets.rpc.inspectRef and resolve through a snapshot-backed infoview RPC method with source position revision and known-constant metadata	add real ExprWithCtx reference storage and lifetime model
...
proofwidgets.rpc	proofwidgets	compat	partial	Vir.ProofWidgets.Rpc;Vir.ProofWidgets.Html;Vir.Infoview.ProofWidgetsRpc	vir-host-bindings;vir-infoview-widget	test:infoview;test:runtime;test:upstream	WithRpcRef and inspectRef support an InteractiveExpr-shaped demo with typed props host inspect action and snapshot-backed resolved-ref status; edit RPC and tactic UI are still missing	add real ExprWithCtx save plus edit and tactic APIs
