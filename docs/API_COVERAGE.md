...
react.components	react	renderer	supported	Vir.React.Component;Vir.React.Hooks	vir-host-bindings	test:runtime;test:upstream	Lean function components with ReactM Node construction hook-backed renderComponent useState useRef resource-shaped useEffect and dependency-list useEffect support	broaden component API as examples require
