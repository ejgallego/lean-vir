...
core.interface.lean_ref	core	interface	supported	Vir.Js	vir-runtime	test:runtime	LeanRef toJs fromJs release move Lean-owned values through opaque JSL handles without structural decoding	specify React ownership and aliasing before automatic cleanup
...
browser.document.query	browser	dom	supported	Vir.Browser.Document	vir-host-bindings	test:runtime;test:upstream	querySelector createElement getTitle setTitle supported	none
