...
infoview.rpc.refs	infoview	rpc	partial	Vir.Infoview.ProofWidgetsRpc;Vir.ProofWidgets.Rpc	vir-host-bindings;vir-infoview-widget	test:infoview;test:runtime;test:upstream	RpcRef descriptors cross proofwidgets.rpc.resolveRef and resolve through a snapshot-backed infoview RPC method with source position revision and known-constant metadata	add real ExprWithCtx reference storage and lifetime model
