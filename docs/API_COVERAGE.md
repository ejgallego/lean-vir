...
core.interface.json_owned	core	interface	supported	Vir.Json	vir-runtime	test:runtime	Lean.Vir.Json crosses ordinary JavaScript JSON as an owned structural value with finite Float numbers	none
