...
react.node.resource	react	renderer	supported	Vir.React.Node	vir-host-bindings	test:runtime;test:upstream	Native ReactNode text element and Fragment resources with Props.Entry props and JS-owned children resources supported	none
