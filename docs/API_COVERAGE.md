...
browser.events	browser	dom	supported	Vir.Browser.Event;Vir.Browser.KeyboardEvent;Vir.Browser.Element	vir-host-bindings	test:runtime;test:upstream	addEventListener removeEventListener target currentTarget exact KeyboardEvent key checked narrowing preventDefault and stopPropagation supported	none
