...
infoview.rpc.session	infoview	rpc	supported	Vir.Infoview.RpcSession;Vir.Infoview.Surface;Vir.Js.Promise;Vir.Js.Function1	vir-host-bindings;vir-infoview-widget	test:infoview;test:infoview:browser;test:runtime;check:bindings	Exact native session and Promise with optional request options; real Lean server and official Chromium React acceptance covers reference identity cancellation rejection position rerender and runtime disposal	broaden concrete RPC clients as needed
infoview.rpc.refs	infoview	rpc	partial	Vir.Infoview.RpcSession;Vir.Infoview.Surface	vir-host-bindings;vir-infoview-widget	test:infoview;test:infoview:browser	Generic native RPC preserves genuine WithRpcRef values; fixture-owned goal snapshots exercise real server references without a public descriptor protocol	elaborator expression/context APIs and edit/tactic clients
