...
proofwidgets.html_subset	proofwidgets	compat	partial	Vir.React.Node	vir-host-bindings;vir-infoview-widget	test:runtime;test:upstream	Substrate supports ReactNode resources and callbacks but no ProofWidgets-style Html DSL	add blessed Html DSL close to ProofWidgets.Data.Html
