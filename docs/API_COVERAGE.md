...
react.node.resource	react	renderer	supported	Vir.React.Node	vir-host-bindings	test:runtime;test:upstream	Native ReactNode text element and Fragment resources with optional keys props handlers children supported	none
