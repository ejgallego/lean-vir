...
react.components	react	renderer	supported	Vir.React.Component;Vir.React.Hooks;Vir.React.ReducerBinding	vir-host-bindings	test:runtime;test:upstream	Lean function components with ReactM Node construction hook-backed renderComponent useState useReducer useRef resource-shaped useEffect and dependency-list useEffect support	broaden component API as examples require
