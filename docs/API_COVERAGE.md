...
proofwidgets.rpc	proofwidgets	compat	partial	Vir.Infoview.RpcSession;Vir.Js.Promise;Vir.ProofWidgets.Rpc;Vir.ProofWidgets.Html;Vir.Infoview.ProofWidgetsRpc	vir-host-bindings;vir-infoview-widget	test:infoview;test:infoview:browser;test:runtime;test:upstream	Direct native RPC client renders real server data and round-trips genuine WithRpcRef values; duplicate global retention store removed	migrate the remaining synthetic JSX descriptor consumer then retire its resolver API
