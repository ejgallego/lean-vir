...
react.root	react	renderer	supported	Vir.React.Root	vir-host-bindings	test:runtime;test:upstream	create createFromSelector mountFromSelector faithful renderNode render adapter renderComponent unmount plus selector-owned renderIntoSelector renderComponentIntoSelector unmountSelector supported	none
