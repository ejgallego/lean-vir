...
canonical `markedModule` wire spelling. Source-file flags and non-module inputs
are rejected; live editor packages use their already elaborated module environment.
